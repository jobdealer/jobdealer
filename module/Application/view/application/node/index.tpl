<div class="hero-unit">
    ...
    <p>
        <a href="{$this->url('node', ['action'=>'add'])}">Add new node</a>
    </p>
    <table class="table table-bordered table-hover">
        ...
        {foreach $nodes as $node}
            <tr>
                ...
                <td>
                    <a href="{$this->url('node', ['action'=>'edit', 'id' => $node->id])}">Edit</a>
                    <a href="{$this->url('node', ['action'=>'delete', 'id' => $node->id])}">Delete</a>
                </td>
            </tr>
            {foreachelse}
