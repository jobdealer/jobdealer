...
INSERT INTO node (nodename, ipaddr, description, lastseen)
    VALUES ('node1', '192.168.0.1', 'node 1', date('now'));
INSERT INTO node (nodename, ipaddr, description, lastseen)
    VALUES ('node2', '192.168.0.2', 'node 2', date('now'));
INSERT INTO node (nodename, ipaddr, description, lastseen)
  VALUES ('node3', '192.168.0.3', 'node 3', date('now'));
INSERT INTO node (nodename, ipaddr, description, lastseen)
  VALUES ('node4', '192.168.0.4', 'node 4', date('now'));